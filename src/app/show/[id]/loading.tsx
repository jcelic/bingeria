const Loading = () => {
  return (
    <main className="mx-auto w-full max-w-5xl px-4 pt-30 pb-10">
      <div className="mb-4 h-10 w-24 animate-pulse rounded-lg bg-zinc-200" />

      <article className="overflow-hidden rounded-2xl bg-white shadow-sm">
        <div className="grid gap-8 p-6 md:grid-cols-[280px_1fr] md:p-8">
          <div className="mx-auto aspect-5/7 w-full max-w-90 animate-pulse rounded-xl bg-zinc-200 md:max-w-none" />

          <div className="animate-pulse">
            <div className="mb-3 h-9 w-64 rounded bg-zinc-200" />
            ...
            <div>
              <div className="mb-4 h-7 w-28 rounded bg-zinc-200" />
